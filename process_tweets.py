...
with open(r"C:\temp\tweet_input\tweets.txt", "r", encoding='utf-8') as ifile1, open(r"C:\temp\tweet_output\ft2.txt", "w") as ofile2:
...
with open(r"C:\temp\tweet_output\ft1.txt", "w") as ofile1:
